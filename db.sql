...
<head>
  ...
  <style id="cfs-style">html***REMOVED***display: none;***REMOVED***</style>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1671772088ltr&server=1">
...
// <![CDATA[
CommonParams.setAll(***REMOVED***common_query:"",opendb_url:"index.php?route=/database/structure",lang:"en",server:"1",table:"",db:"",token:"70395360273927653923363b655f287b",text_dir:"ltr",show_databases_navigation_as_tree:true,pma_text_default_tab:"Browse",pma_text_left_default_tab:"Structure",pma_text_left_default_tab2:false,LimitChars:"50",pftext:"P",confirm:true,LoginCookieValidity:"1440",session_gc_maxlifetime:"1440",logged_in:true,is_https:false,rootPath:"/phpmyadmin/",arg_separator:"&",PMA_VERSION:"5.1.3",auth_type:"config",user:"root"***REMOVED***);
...
function extendingValidatorMessages () ***REMOVED***
...
// ]]>
  ...
  <noscript><style>html***REMOVED***display:block***REMOVED***</style></noscript>
</head>
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=kompiuterija&table=shop">`kompiuterija`.`shop`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=kompiuterija&table=computer">`kompiuterija`.`computer`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=kompiuterija&table=part">`kompiuterija`.`part`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=kompiuterija&table=Shop">`kompiuterija`.`Shop`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=laravel&table=shelves">`laravel`.`shelves`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=laravel&table=users">`laravel`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=laravel&table=user_roles">`laravel`.`user_roles`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=laravel&table=failed_jobs">`laravel`.`failed_jobs`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=laravel&table=migrations">`laravel`.`migrations`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=laravel&table=password_resets">`laravel`.`password_resets`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="70395360273927653923363b655f287b">
...
<script type="text/javascript">
    if (typeof configInlineParams === 'undefined' || !Array.isArray(configInlineParams)) ***REMOVED***
        configInlineParams = [];
***REMOVED***
    configInlineParams.push(function () ***REMOVED***
...
$.extend(Messages, ***REMOVED***
	...
	'error_value_lte': 'Value must be less than or equal to %s!'***REMOVED***);
$.extend(defaultValues, ***REMOVED***
	...
	'NavigationTreeTableLevel': '1'***REMOVED***);
***REMOVED***);
    if (typeof configScriptLoaded !== 'undefined' && configInlineParams) ***REMOVED***
        loadInlineConfig();
***REMOVED***
</script>
</div></div>
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="kompiuterija" targettable="shop">
